  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        ...
        setProducts([
          {
            _id: "9939d10a-4d83-4971-87d5-da1096e46cac",
            name: "Bag",
          ...
          {
            _id: "db7561bc-36d6-40b8-abfe-1dc37160b8f0",
            name: "Bag",
            description: "Bag",
            base_price: 910,
            discount_price: 1011,
          ...
          {
            _id: "af153d64-36b5-427f-b46d-7a6f36afe6c3",
            name: "test product1",
            description: "itisgood",
            base_price: 10,
            discount_price: 1,
            qty: 100,
            is_published: true,
          ...
          {
            _id: "cb30419e-d8fd-406d-91f8-f0727cfc0268",
            name: "test product2",
            description: "itisgood",
            base_price: 20,
            discount_price: 2,
          ...
          {
            _id: "a4db5221-348d-44a5-8c7d-9d71a55ca0c1",
            name: "test product3",
            description: "itisgood",
            base_price: 30,
            discount_price: 3,
